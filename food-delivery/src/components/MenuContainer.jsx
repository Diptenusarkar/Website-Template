...
const MenuContainer = () => {
  const [filter, setFilter] = useState("MHC");

  const [{ foodItems }, dispatch] = useStateValue();

  return (
    <section className="w-full my-6" id="menu">
      {/* Second section, Fast Food */}
      ...
      <div className="w-full flex flex-col items-center justify-center ">
        ...
        <div className="w-full flex items-center justify-start overflow-x-scroll scrollbar-hide md:overflow-x-auto lg:justify-center gap-8 py-6 ">
          {categories &&
            categories.map((category) => (
              ...
              >
                ...
                {/* Names showing in cards */}
                <p
                  className={`text-sm text-center max-w-full ${filter === category.urlParamName
                      ? "text-white"
                      : "text-textColor"
